  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1fr_340px]">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <span
                    className="hidden text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100 sm:inline"
                    aria-hidden="true"
                  >
      ...
      <div className="space-y-6">
          ...
          <div className="mt-4 space-y-2.5">
            {!selectedDate && (
              <p className="py-6 text-center text-sm text-muted-foreground">
                اضغط على أي يوم في التقويم لعرض أحداثه
              </p>
            )}
        ...
        {/* الأحداث القادمة */}
        <Card className="gap-0 p-5">
          <h3 className="text-base font-bold text-foreground">الأحداث القادمة</h3>
          <div className="mt-4 space-y-2.5">
            {upcoming.length === 0 && (
              <p className="py-6 text-center text-sm text-muted-foreground">
                لا توجد أحداث قادمة
  ...
  return (
    <div
      className={cn(
        ...
        eventTypeStyles[event.type].bar,
      )}
    >
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-1">
          ...
          <button
            type="button"
            onClick={onDelete}
            className="flex size-7 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-card hover:text-rose-600"
