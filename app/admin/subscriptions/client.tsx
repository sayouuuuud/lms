...
const STATUS_STYLES: Record<string, string> = {
  active: 'bg-purple-50 text-brand',
...
const REQUEST_STATUS_STYLES: Record<string, string> = {
  ...
  approved: 'bg-purple-50 text-brand',
